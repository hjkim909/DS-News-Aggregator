...
#### 0️⃣ Railway 수집 최적화 (Priority: URGENT)
**목표:** Railway에서 수집 시 5개만 나오는 문제 해결

**확인 사항:**
- Railway Variables에 `GEMINI_API_KEY` 설정 확인
- API 할당량 확인 (Gemini Pro 무료 한도)
- 타임아웃 설정 확인
